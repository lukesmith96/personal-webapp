	...
	[
        {
            ...
            description: `
                ...
                \n
                The team I have been able to help lead focuses on endpoint security and network visibility. We develop the tools that secure and validate the security of Amazon's vast network. This security directly correlates to trust by customers and employees. I lead the development of a geographically distributed network canary, generating custom queries to test services across Amazon’s global network. As well as being a part of the design and development of multiple different security services such as a local dns sinkhole now deployed over 500 thousand hosts, and other services to maintain Amazon's data security.
                \n
